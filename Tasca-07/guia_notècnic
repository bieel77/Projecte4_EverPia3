# Guia per rebre ajuda de Anydesk

### En primer lloc entra a un navegador i descarrega l'aplicació de AnyDesk amb el link.

[AnyDesk](https://anydesk.com/es/downloads)

``` bash
https://anydesk.com/es/downloads
```

### Un cop dintre del link, prem la opció marcada en la captura de pantalla.

<img width="1919" height="694" alt="image" src="https://github.com/user-attachments/assets/2da75cae-f67a-4944-ba0c-f6bbef3c09db" />

### Si et demana guardarlo prem "Desa" si no, es que ja s'et 

<img width="951" height="531" alt="image" src="https://github.com/user-attachments/assets/ea161d2b-5409-4d1a-bd6e-697b630b7312" />
